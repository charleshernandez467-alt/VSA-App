...
1. streamlit_app_.py: The main script for the dashboard, which contains the logic for filtering, displaying KPIs, and generating the charts.
...
5. Future Archives Integration: On future projects we'll be able to manage confidential data, so do "carpeta_FGJ_acumulado_01.py"
